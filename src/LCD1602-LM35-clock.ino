...
void loop()
{
 ...
 // ----------------карта памяти SD------------------------------------------------------------------------------------------------------------
    ...
    logStringData.concat(t);
    logStringData.concat(',');
    logStringData.concat(h);
    logStringData.concat(',');
    logStringData.concat(pressureInt);
    logStringData.concat(',');
    logStringData.concat(ppmcResult);
    logStringData.concat(',');
    logStringData.concat(String(now.unixtime()));
